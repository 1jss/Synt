...
var CGUI = function()
{
  ...
  var soundboxBinToSong = function (d) {
    ...
    if (signature != makeFourCC("Synt") || (version < 1 || version > 12))
      return undefined;
  ...
  var songToJS = function (song) {
    ...
    jsData += "    // This music has been exported by Synt.\n\n";
  ...
  var updateCheckBox = function (o, check) {
    o.src = check ? "gui/box-check.svg" : "gui/box-uncheck.svg";
  };
  ...
  var updateInstrument = function (resetPreset) {
    ...
    // Oscillator 1
    document.getElementById("osc1_wave_sin").src = instrI[OSC1_WAVEFORM] == 0 ? "gui/wave-sin-sel.svg" : "gui/wave-sin.svg";
    document.getElementById("osc1_wave_sqr").src = instrI[OSC1_WAVEFORM] == 1 ? "gui/wave-sqr-sel.svg" : "gui/wave-sqr.svg";
    document.getElementById("osc1_wave_saw").src = instrI[OSC1_WAVEFORM] == 2 ? "gui/wave-saw-sel.svg" : "gui/wave-saw.svg";
    document.getElementById("osc1_wave_tri").src = instrI[OSC1_WAVEFORM] == 3 ? "gui/wave-tri-sel.svg" : "gui/wave-tri.svg";
    ...
    // Oscillator 2
    document.getElementById("osc2_wave_sin").src = instrI[OSC2_WAVEFORM] == 0 ? "gui/wave-sin-sel.svg" : "gui/wave-sin.svg";
    document.getElementById("osc2_wave_sqr").src = instrI[OSC2_WAVEFORM] == 1 ? "gui/wave-sqr-sel.svg" : "gui/wave-sqr.svg";
    document.getElementById("osc2_wave_saw").src = instrI[OSC2_WAVEFORM] == 2 ? "gui/wave-saw-sel.svg" : "gui/wave-saw.svg";
    document.getElementById("osc2_wave_tri").src = instrI[OSC2_WAVEFORM] == 3 ? "gui/wave-tri-sel.svg" : "gui/wave-tri.svg";
    ...
    // LFO
    document.getElementById("lfo_wave_sin").src = instrI[LFO_WAVEFORM] == 0 ? "gui/wave-sin-sel.svg" : "gui/wave-sin.svg";
    document.getElementById("lfo_wave_sqr").src = instrI[LFO_WAVEFORM] == 1 ? "gui/wave-sqr-sel.svg" : "gui/wave-sqr.svg";
    document.getElementById("lfo_wave_saw").src = instrI[LFO_WAVEFORM] == 2 ? "gui/wave-saw-sel.svg" : "gui/wave-saw.svg";
    document.getElementById("lfo_wave_tri").src = instrI[LFO_WAVEFORM] == 3 ? "gui/wave-tri-sel.svg" : "gui/wave-tri.svg";
    ...
    // Effects
    document.getElementById("fx_filt_lp").src = instrI[FX_FILTER] == 2 ? "gui/filt-lp-sel.svg" : "gui/filt-lp.svg";
    document.getElementById("fx_filt_hp").src = instrI[FX_FILTER] == 1 ? "gui/filt-hp-sel.svg" : "gui/filt-hp.svg";
    document.getElementById("fx_filt_bp").src = instrI[FX_FILTER] == 3 ? "gui/filt-bp-sel.svg" : "gui/filt-bp.svg";
  ...
  var showOpenDialog = function () {
    ...
    o.appendChild(document.createTextNode("To open a song you simply drag and drop it in the editor."));
    parent.appendChild(o);
  ...
  var showSaveDialog = function () {
    ...
    o = document.createElement("p");
    o.appendChild(document.createTextNode("Data URL:"));
    parent.appendChild(o);
    ...
    o = document.createElement("input");
    o.type = "submit";
    o.value = "Save as file";
    o.title = "Save the song as a file.";
    o.onclick = function () {
  ...
  this.init = function ()
  {
    ...
    // Preload images
    preloadImage("gui/box-uncheck.svg");
    preloadImage("gui/box-uncheck.svg");
    preloadImage("gui/wave-sin.svg");
    preloadImage("gui/wave-sin-sel.svg");
    preloadImage("gui/wave-saw.svg");
    preloadImage("gui/wave-saw-sel.svg");
    preloadImage("gui/wave-sqr.svg");
    preloadImage("gui/wave-sqr-sel.svg");
    preloadImage("gui/wave-tri.svg");
    preloadImage("gui/wave-tri-sel.svg");
    preloadImage("gui/filt-lp.svg");
    preloadImage("gui/filt-lp-sel.svg");
    preloadImage("gui/filt-hp.svg");
    preloadImage("gui/filt-hp-sel.svg");
    preloadImage("gui/filt-bp.svg");
    preloadImage("gui/filt-bp-sel.svg");
